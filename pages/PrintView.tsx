...
export default function PrintView() {
  ...
  // Fixed logic error where a.date || [] was used instead of a string in sort
  ...
  return (
    <div className="bg-gray-100 min-h-screen pb-12 print:pb-0 print:bg-white report-root" dir={dir}>
      ...
      <div id="report-content" className="overflow-visible report-root">
        ...
        {/* AGREEMENTS PAGE - Fixed syntax error with robust ternary structure */}
        {agreementChunks && agreementChunks.length > 0 ? (
