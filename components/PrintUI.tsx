...
export const PageContainer: React.FC<{
  ...
  <div className={`w-[210mm] h-[297mm] bg-white mx-auto flex flex-col page-break relative overflow-visible ${className}`}>
    {/* Explicitly defined safe-zone for content to prevent footer overlap. 
        Increased padding bottom to 32 (8rem/128px) to safely house the footer. */}
    <div className="px-12 pt-8 pb-32 flex-1 overflow-visible">{children}</div>
