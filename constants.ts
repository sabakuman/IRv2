...
export const TRANSLATIONS = {
  en: {
    ...
    wpsWageTransferRate: 'Number of private sector workers who received their wages through WPS during the last 3 months',
  ...
  ar: {
    ...
    wpsWageTransferRate: 'عدد العمالة القطاع الخاص التي قامت باستلام رواتبها من خلال نظام حماية الأجور خلال آخر (3) أشهر',
