...
export const TRANSLATIONS = {
  en: {
    ...
    unemploymentInsuranceCoverageRate: 'Unemployment Insurance Scheme Coverage Rate',
    wpsWageTransferRate: 'Wage Protection System (WPS) Wage Transfer Rate',
  ...
  ar: {
    ...
    callingCode: 'مفتاح الاتصال الدولي',
    ...
    unemploymentInsuranceCoverageRate: 'نسبة تغطية العمالة في برنامج التأمين ضد التعطل عن العمل',
    wpsWageTransferRate: 'نسبة تحويل الأجور في نظام حماية الأجور',
