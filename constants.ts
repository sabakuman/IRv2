...
export const TRANSLATIONS = {
  en: {
    ...
    currency: 'Currency',
    directFlight: 'Direct Flights from UAE',
    totalWorkersInUae: 'Total Workers in UAE',
    ...
    unemploymentInsuranceCoverageRate: 'Private sector workers covered under the unemployment insurance system',
    wpsWageTransferRate: 'Percentage of private sector workers who received their wages through WPS during the last 3 months',
    totalWorkforceInUaeLaborMarket: 'Total Workforce in UAE Labor Market',
    insuranceUnemploymentExposed: 'Private sector workers exposed/not covered under the unemployment insurance system',
    insuranceRightsCovered: 'Private sector workers covered under the worker rights insurance system',
    insuranceRightsExposed: 'Private sector workers exposed/not covered under the worker rights insurance system',
    wageMedianComparison: 'Distribution of wage median for this nationality compared to labor market median by skill level',
    workersLaborStrikes: 'Number of workers who participated in labor strikes during the current year',
    laborComplaintsUnderReview: 'Labor complaints under review',
    totalComplaintsCurrentYear: 'Total labor complaints for current year',
    workersThreeYearTrend: 'Total workforce (last 3 years) & growth trend',
    threeYearTotal: '3-Year Total',
    growthRate: 'Change Rate',
    increase: 'Increase',
    decrease: 'Decrease',
    stable: 'Stable',
    netChange: 'Net Change',
    growthVolume: 'Growth Volume',
    declineVolume: 'Decline Volume',
    emiratesDistributionCombined: 'Workforce distribution by Emirate (MOHRE & ICP)',
    metBeforeQuestion: 'Have we met this delegate before?',
    previouslyMet: 'Previously met',
    meetingYear: 'Meeting Year',
    meetingLocation: 'Meeting Location',
    totalPrivate: 'Total Private Sector',
    totalDomestic: 'Total Domestic Workers',
    dataAsOf: 'Data as of',
    workersByEmirate: 'Workers by Emirate (MOHRE & ICP)',
    ...
    previousAgreementsAndUpdates: 'Key Agreements & Work Updates',
    pendingMatters: 'Matters Under Review',
    pendingMattersDesc: 'Active follow-ups and inter-departmental pending files for the Executive Brief.',
    addPendingMatter: 'Add Matter Under Review',
    ...
    customLabel: 'Custom',
    customStatusText: 'Custom Status Label',
    ...
    // MOU Tracker
    mouTracker: 'MOU Tracker',
    mouTrackerSubtitle: 'Strategic repository for Memoranda of Understanding, tracking bilateral labor agreements and implementation progress.',
    allMOUs: 'All MOUs',
    activeMOUs: 'Active MOUs',
    pendingRenewal: 'Pending Renewal',
    expiringSoon: 'Expiring Soon',
    missingAttachments: 'Missing Attachments',
    upcomingJCM: 'Upcoming JCM',
    mouTitle: 'MOU Title',
    ...
    labour: 'Labour Protocol / Worker Protocol',
    domestic: 'Domestic Worker Protocol',
    both: 'Both (Labour & Domestic)',
    other: 'Other',
    expired: 'Expired',
    under_discussion: 'Under Discussion',
    overview: 'Overview',
    attachments: 'Attachments',
    timeline: 'Meetings or Interactions',
    actions: 'Recommendations / Action Plans',
    export: 'Export',
    addUpdate: 'Add New Update',
    assignedTo: 'Assigned To',
    dueDate: 'Due Date',
    mouSigning: 'MOU Signing',
    jcm: 'Joint Committee Meeting (JCM)',
    technicalMeeting: 'Technical Meeting',
    bilateralMeeting: 'Bilateral Meeting',
    renewalDiscussion: 'Renewal Discussion',
    amendment: 'Amendment',
    dispute: 'Dispute',
    generalUpdate: 'General Update',
    lastJCMDate: 'Last JCM Date',
    nextJCMDate: 'Next JCM Date',
    totalJCMCount: 'Total JCM Count',
    auditLog: 'Audit Log',
    daysRemaining: 'days remaining',
    mouDetail: 'MOU Details',
    editMOU: 'Edit MOU',
    addMOU: 'Add New MOU',
  },
  ar: {
    ...
    currency: 'العملة',
    directFlight: 'رحلات مباشرة من الإمارات',
    totalWorkersInUae: 'إجمالي العمالة في الإمارات',
    ...
    mohreData: 'بيانات وزارة الموارد البشرية و التوطين (MOHRE)',
    icpData: 'بيانات الهيئة (ICP)',
    mohrePrivate: 'وزارة الموارد البشرية و التوطين • القطاع الخاص',
    mohreDomestic: 'وزارة الموارد البشرية و التوطين • العمالة المساعدة',
    unemploymentInsuranceCoverageRate: 'عدد عمالة القطاع الخاص المغطاه ضمن نظام التأمين ضد التعطل عن العمل',
    wpsWageTransferRate: 'نسبة عمالة القطاع الخاص التي قامت باستلام رواتبها من خلال نظام حماية الأجور خلال آخر (3) أشهر',
    totalWorkforceInUaeLaborMarket: 'إجمالي العمالة في سوق العمل بالدولة',
    insuranceUnemploymentExposed: 'عدد عمالة القطاع الخاص المنكشفة ضمن نظام التأمين ضد التعطل عن العمل',
    insuranceRightsCovered: 'عدد عمالة القطاع الخاص المغطاه ضمن نظام التأمين على حقوق العمالة',
    insuranceRightsExposed: 'عدد عمالة القطاع الخاص المنكشفة ضمن نظام التأمين على حقوق العمالة',
    wageMedianComparison: 'وسيط رواتب عاملة هذه الجنسية في الإمارات',
    workersLaborStrikes: 'عدد العمالة التي شاركت في إضرابات عمالية خلال العام الحالي',
    laborComplaintsUnderReview: 'شكاوى عمالية قيد البحث',
    totalComplaintsCurrentYear: 'إجمالي عدد الشكاوى العمالية للسنة الحالية',
    workersThreeYearTrend: 'إجمالي أعداد العمالة لآخر 3 سنوات ونسبة التغير',
    threeYearTotal: 'مجموع الـ 3 سنوات',
    growthRate: 'نسبة التغير',
    increase: 'زيادة',
    decrease: 'انخفاض',
    stable: 'استقرار',
    netChange: 'نسبة ومقدار التغير',
    growthVolume: 'نسبة ومقدار النمو',
    declineVolume: 'نسبة ومقدار التراجع',
    emiratesDistributionCombined: 'توزيع العاملين حسب الإمارة (MOHRE & ICP)',
    metBeforeQuestion: 'هل تم اللقاء به مسبقاً؟',
    previouslyMet: 'تم اللقاء مسبقاً',
    meetingYear: 'سنة اللقاء',
    meetingLocation: 'مكان اللقاء',
    totalPrivate: 'إجمالي القطاع الخاص',
    totalDomestic: 'إجمالي العمالة المساعدة',
    dataAsOf: 'البيانات حتى',
    workersByEmirate: 'توزيع العمال حسب الإمارة (MOHRE & ICP)',
    residentsByEmirate: 'توزيع العاملين حسب الإمارة (ICP)',
    ...
    genderDistribution: 'نسبة توزيع العمالة حسب الجنس',
    ...
    exportsToUae: 'الواردات إلى الإمارات',
    importsFromUae: 'الصادرات من الإمارات',
    ...
    previousAgreementsAndUpdates: 'أبرز ما تم الاتفاق عليه خلال الاجتماعات السابقة ومستجدات العمل',
    pendingMatters: 'المواضيع تحت المراجعة',
    pendingMattersDesc: 'متابعات وتنسيقات قيد الإنجاز بين القطاعات والجانب المقابل للملخص التنفيذي.',
    addPendingMatter: 'إضافة موضوع تحت المراجعة',
    ...
    customLabel: 'مخصص',
    customStatusText: 'نص الحالة المخصص',
    noAgreements: 'لا توجد اتفاقيات رسمية مسجلة.',
    type: 'النوع',
    details: 'التفاصيل',
    icpDisclaimer: 'تعكس بيانات ICP سجلات الإقامة، بينما تعكس بيانات وزارة الموارد البشرية و التوطين (MOHRE) علاقات العمل المسجلة في القطاع الخاص.',
    ...
    // MOU Tracker
    mouTracker: 'متتبع مذكرات التفاهم',
    mouTrackerSubtitle: 'المستودع الاستراتيجي لمذكرات التفاهم، لمتابعة اتفاقيات العمل الثنائية ومراحل التنفيذ.',
    allMOUs: 'كافة المذكرات',
    activeMOUs: 'المذكرات السارية',
    pendingRenewal: 'قيد التجديد',
    expiringSoon: 'تنتهي قريباً',
    missingAttachments: 'مرفقات ناقصة',
    upcomingJCM: 'اللجنة المشتركة القادمة',
    mouTitle: 'عنوان المذكرة',
    organization: 'المنظمة / الجهة',
    mouType: 'نوع المذكرة',
    signedDate: 'تاريخ التوقيع',
    expiryDate: 'تاريخ الانتهاء',
    lastUpdate: 'آخر تحديث',
    labour: 'اتفاقية في العمل',
    domestic: 'اتفاقية في العمالة المساعدة',
    both: 'كلاهما (اتفاقية في العمل والعمالة المساعدة)',
    other: 'أخرى',
    active: 'ساري',
    pending: 'قيد التنفيذ',
    expired: 'منتهي',
    ...
    timeline: 'الاجتماعات أو التفاعلات',
    actions: 'التوصيات / خطط العمل',
    export: 'تصدير',
    addUpdate: 'إضافة تحديث جديد',
    assignedTo: 'مكلف إلى',
    dueDate: 'تاريخ الاستحقاق',
    mouSigning: 'توقيع المذكرة',
    jcm: 'اجتماع اللجنة المشتركة (JCM)',
    technicalMeeting: 'اجتماع فني',
    bilateralMeeting: 'اجتماع ثنائي',
    renewalDiscussion: 'نقاشات التجديد',
    amendment: 'تعديل / ملحق',
    dispute: 'نزاع / شكوى',
    generalUpdate: 'تحديث عام',
    lastJCMDate: 'تاريخ آخر لجنة مشتركة',
    nextJCMDate: 'تاريخ اللجنة المشتركة القادمة',
    totalJCMCount: 'إجمالي عدد اللجان المشتركة',
    auditLog: 'سجل العمليات',
    daysRemaining: 'يوم متبقي',
    mouDetail: 'تفاصيل المذكرة',
    editMOU: 'تعديل المذكرة',
    addMOU: 'إضافة مذكرة جديدة',
  }
};