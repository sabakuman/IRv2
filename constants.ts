...
export const TRANSLATIONS = {
  en: {
    ...
    loginSubtitle: 'Secure Portal for Ministerial Bilateral Intelligence',
    dashboard: 'Dashboard',
    reports: 'Reports',
    settings: 'Settings',
    ...
    strategicOverview: 'Strategic Intelligence Overview',
    ...
    tradeEducation: 'Trade & Education Analysis',
    educationInsights: 'Education Insights',
    tipRankLabel: 'TIP Ranking',
    bilateralTrade: 'Bilateral Trade Overview',
    mohrePrivate: 'Private Sector (MOHRE)',
    mohreDomestic: 'Domestic Workers (MOHRE)',
    domesticAnalysis: 'Domestic Participation Analysis',
    workforceOf: 'Workforce Profile',
    sourceMarketAnalysis: 'Source Market Intelligence',
    skillsDisclaimer: 'Analysis based on ministerial labor mobility frameworks.',
    relationshipSummary: 'Bilateral Relationship Summary',
    noAgreements: 'No active bilateral agreements found.',
    generatedOn: 'Generated on',
    reportNotFound: 'Report Not Found',
    reportNotFoundMsg: 'The requested intelligence dossier could not be retrieved.',
    generatingDoc: 'Generating Ministerial Dossier...',
  },
  ar: {
    ministry: 'وزارة الموارد البشرية والتوطين',
    loginTitle: 'استخبارات سوق العمل',
    loginSubtitle: 'بوابة آمنة للاستخبارات الثنائية الوزارية',
    ...
    deleteLetter: 'التقرير غير موجود',
    personalApiKey: 'مفتاح Gemini API الشخصي',
    strategicOverview: 'نظرة عامة على الاستخبارات الاستراتيجية',
    subjectMarket: 'السوق المعني',
    reference: 'رقم المرجع',
    date: 'تاريخ التقرير',
    securityClass: 'التصنيف الأمني',
    officialRestricted: 'رسمي - محدود',
    keyDemographics: 'الديموغرافيا الأساسية',
    economicLandscape: 'المشهد الاقتصادي',
    tradeEducation: 'تحليل التجارة والتعليم',
    educationInsights: 'رؤى تعليمية',
    tipRankLabel: 'تصنيف الاتجار بالبشر',
    bilateralTrade: 'نظرة عامة على التجارة الثنائية',
    mohrePrivate: 'القطاع الخاص (وزارة الموارد البشرية)',
    mohreDomestic: 'العمالة المساعدة (وزارة الموارد البشرية)',
    domesticAnalysis: 'تحليل المشاركة في السوق المحلي',
    workforceOf: 'ملف القوى العاملة',
    sourceMarketAnalysis: 'استخبارات سوق المصدر',
    skillsDisclaimer: 'تحليل مبني على أطر تنقل العمالة الوزارية.',
    relationshipSummary: 'ملخص العلاقة الثنائية',
    noAgreements: 'لا توجد اتفاقيات ثنائية نشطة.',
    generatedOn: 'تم الإنشاء في',
    reportNotFound: 'التقرير غير موجود',
    reportNotFoundMsg: 'تعذر استرجاع ملف الاستخبارات المطلوب.',
    generatingDoc: 'جاري إنشاء الملف الوزاري...',
  }
};
