...
export const TRANSLATIONS = {
  en: {
    ...
    remittancesGlobal: 'Global Remittances',
    ...
    reportsDescription: 'View and manage all bilateral relationship reports.',
    colReportTitle: 'Report Title',
    colCreatedBy: 'Created By',
    colLastModified: 'Last Modified',
    colStatus: 'Status',
    colActions: 'Actions',
    letterLogSubtitle: 'Track official correspondence and diplomatic communications.',
    all: 'All',
  ...
  ar: {
    ...
    remittancesGlobal: 'الحوالات العالمية',
    topExports: 'أهم المنتجات المصدرة',
    topImports: 'أهم المنتجات المستوردة',
    primaryEnrollment: 'االلتحاق بالتعليم الابتدائي',
    higherEducationEnrollment: 'االلتحاق بالتعليم العالي',
    ...
    reportsDescription: 'عرض وإدارة جميع تقارير العلاقات الثنائية.',
    colReportTitle: 'عنوان التقرير',
    colCreatedBy: 'أنشئ بواسطة',
    colLastModified: 'آخر تعديل',
    colStatus: 'الحالة',
    colActions: 'الإجراءات',
    letterLogSubtitle: 'تتبع المراسلات الرسمية والاتصالات الدبلوماسية.',
    all: 'الكل',
